...
def object_service_list_to_csv(output_file, data):
    ...
    for line in data:
        ...
        if line.startswith(wordresearch):
            ...
            if line.startswith("service"):
                ...
                current_protocol = description_string
    ...
    with open(Path, 'w', newline='') as csv_file:
        ...
        writer.writerow(["Object Service", "Service" , "Description"])

        for group in result:
            object_group_name = group["Object Service"].split(" ")[-1]
            writer.writerow([object_group_name, group["Service"],  group["Description"]])
